...
export default function Unlocks(props) {
		...
		if (!item.unlocked) {
			scenarioArray.push(
				<div className='unlock-row' key={i}>
					<input type='checkbox' id={i} name='scenario' onChange={handleUnlock} />
	...
	unlocks.treasure.forEach((item, i) => {
		if (!item.unlocked) {
			treasureArray.push(
				<div className='unlock-row' key={i}>
					<input type='checkbox' id={i} name='treasure' onChange={handleUnlock} />
	...
	unlocks.event.forEach((item, i) => {
		if (!item.unlocked) {
			eventArray.push(
				<div className='unlock-row' key={i}>
					<input type='checkbox' id={i} name='event' onChange={handleUnlock} />
